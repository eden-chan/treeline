 ...
 */
class Reactor {
    constructor(config, Storage = IndexedDBStorage_1.default, NetworkListener = WindowNetworkListener_1.default) {
        this._isOnline = true;
        ...
        this._wsOnError = (e) => {
            log_1.default.error("[socket] error: ", e);
        };
        this._wsOnClose = () => {
            ...
            if (this._isShutdown) {
                log_1.default.info("[socket-close] socket has been shut down and will not reconnect");
                return;
            }
            if (this._isManualClose) {
                this._isManualClose = false;
                log_1.default.info("[socket-close] manual close, will not reconnect");
                return;
            }
            ...
            setTimeout(() => {
                ...
                if (!this._isOnline) {
                    log_1.default.info("[socket-close] we are offline, no need to start socket");
                    return;
                }
                this._startSocket();
