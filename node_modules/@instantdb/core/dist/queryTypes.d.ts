import type { EntitiesDef, InstantGraph, LinkAttrDef, ResolveAttrs } from "./schemaTypes";
type NonEmpty<T> = {
...
type InstaQLQuerySubqueryParams<S extends InstantGraph<any, any>, E extends keyof S["entities"]> = {
...
export { Query, QueryResponse, PageInfoResponse, InstantObject, Exactly, Remove$, InstaQLQueryResult, InstaQLQueryParams, InstaQLQueryEntityResult, Cursor, };
