...
const instaml_1 = require("./instaml");
...
function getPrimaryKeyAttr(store, ns) {
    const primary = Object.values(store.attrs).find((a) => { var _b; return a["primary?"] && ((_b = a["forward-identity"]) === null || _b === void 0 ? void 0 : _b[1]) === ns; });
    if (primary) {
        return primary;
    }
    return (0, instaml_1.getAttrByFwdIdentName)(store.attrs, ns, "id");
}
...
function refAttrPat(makeVar, store, etype, level, label) {
    const fwdAttr = (0, instaml_1.getAttrByFwdIdentName)(store.attrs, etype, label);
    const revAttr = (0, instaml_1.getAttrByReverseIdentName)(store.attrs, etype, label);
...
function valueAttrPat(makeVar, store, valueEtype, valueLevel, valueLabel, v) {
    const attr = (0, instaml_1.getAttrByFwdIdentName)(store.attrs, valueEtype, valueLabel);
    if (!attr) {
    ...
    return Object.entries(objects).map(([eid, parent]) => {
        const childResults = children.map((label) => {
            ...
            const isSingular = Boolean(store.cardinalityInference &&
                ((_d = (_c = (_b = store.linkIndex) === null || _b === void 0 ? void 0 : _b[etype]) === null || _c === void 0 ? void 0 : _c[label]) === null || _d === void 0 ? void 0 : _d.isSingular));
            try {
