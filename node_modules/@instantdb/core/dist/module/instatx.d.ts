...
export interface ETypeChunk<Schema extends InstantGraph<any, any>, EntityName extends keyof Schema["entities"]> {
...
export declare function txInit<Schema extends InstantGraph<any, any>>(): TxChunk<Schema>;
/**
 ...
 */
export declare const tx: TxChunk<InstantGraph<any, any, {}>>;
