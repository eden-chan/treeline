...
interface Props<T_HT> {
  ...
  displayHighlights: Array<AnnotatedPdfHighlight>;
  onScrollChange: () => void;
  scrollRef: (scrollTo: (highlight: AnnotatedPdfHighlight) => void) => void;
  highlight: AnnotatedPdfHighlight | undefined;
