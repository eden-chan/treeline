...
const arxivLinkPattern =
	/^https?:\/\/(?:www\.)?arxiv\.org\/pdf\/[0-9]+\.[0-9]+(?:v[0-9]+)?\.pdf$/;
		...
		<Dialog>
			...
			<DialogContent className="sm:max-w-md">
				<DialogHeader>
					...
					<DialogDescription>Import a PDF to your library</DialogDescription>
				</DialogHeader>
				<form
					className="flex items-center space-x-2"
					onSubmit={handleEnterOrSubmit}
				>
