...
var require_xmlNode = __commonJS((exports, module) => {
  class XmlNode {
    ...
    addChild(node4) {
      if (node4.tagname === "__proto__") node4.tagname = "#__proto__";
...
var require_DocTypeReader = __commonJS((exports, module) => {
  ...
  var validateEntityName = function (name) {
    if (util8.isName(name)) return name;
...
var require_OrderedObjParser = __commonJS((exports, module) => {
  ...
  var saveTextToParentTag = function (
    textData,
    currentNode,
    jPath,
    isLeafNode,
    ...
    for (let i = 0; i < arr.length; i++) {
      ...
      if (property === options.textNodeName) {
        ...
        if (tagObj[":@"]) {
          ...
          val2[options.textNodeName] !== undefined &&
  ...
  (function (e2, t2) {
    ...
    return (function (e2) {
      ...
      function r2(n2) {
        ...
        return (
          e2[n2].call(i2.exports, i2, i2.exports, r2), (i2.l = true), i2.exports
        );
      }
      return (
        (r2.m = e2),
        ...
        var d2 = (function () {
          ...
          return (
            ...
            (t3.parseBrowser = function () {
              ...
              return (
                t4 && (this.parsedResult.browser = t4.describe(this.getUA())),
                this.parsedResult.browser
              );
            }),
            ...
            (t3.parsePlatform = function () {
              ...
              return (
                t4 && (this.parsedResult.platform = t4.describe(this.getUA())),
                this.parsedResult.platform
              );
            }),
            ...
            (t3.parseEngine = function () {
              ...
              return (
                t4 && (this.parsedResult.engine = t4.describe(this.getUA())),
                this.parsedResult.engine
              );
            }),
            (t3.parse = function () {
            ...
            (t3.satisfies = function (e4) {
              ...
              if (
                (Object.keys(e4).forEach(function (t5) {
                  ...
                  typeof a4 == "string"
                    ? ((i3[t5] = a4), (s4 += 1))
                    : typeof a4 == "object" && ((r3[t5] = a4), (n3 += 1));
                }),
                n3 > 0)
              ) {
              ...
              if (s4 > 0) {
                ...
                if (h2 !== undefined) return this.compareVersion(i3[h2]);
              }
            }),
            ...
            (t3.is = function (e4, t4) {
              return (
                t4 === undefined && (t4 = false),
                this.isBrowser(e4, t4) || this.isOS(e4) || this.isPlatform(e4)
              );
            }),
            (t3.some = function (e4) {
              var t4 = this;
          ...
          a2 = [
            {
              ...
              describe: function (e3) {
                var t3 = { name: "Googlebot" },
                  r3 =
                    i2.default.getFirstMatch(/googlebot\/(\d+(\.\d+))/i, e3) ||
            ...
            },
            {
              ...
              describe: function (e3) {
                var t3 = { name: "Opera" },
                  r3 =
                    i2.default.getFirstMatch(/(?:opr|opios)[\s/](\S+)/i, e3) ||
                    i2.default.getFirstMatch(s2, e3);
                return r3 && (t3.version = r3), t3;
              },
            },
            ...
            },
            {
              ...
              describe: function (e3) {
                var t3 = { name: "Microsoft Edge" },
                  r3 = i2.default.getFirstMatch(/\sedg\/(\d+(\.?_?\d+)+)/i, e3);
                return r3 && (t3.version = r3), t3;
              },
            },
            {
            ...
            },
            {
              ...
              describe: function (e3) {
                var t3 = { name: "Amazon Silk" },
                  r3 = i2.default.getFirstMatch(/silk\/(\d+(\.?_?\d+)+)/i, e3);
                return r3 && (t3.version = r3), t3;
              },
            },
            {
          ...
          },
          {
            ...
            describe: function (e3) {
              var t3 = { name: s2.ENGINE_MAP.Trident },
                r3 = i2.default.getFirstMatch(/trident\/(\d+(\.?_?\d+)+)/i, e3);
              return r3 && (t3.version = r3), t3;
            },
          },
          {
            ...
            describe: function (e3) {
              var t3 = { name: s2.ENGINE_MAP.Presto },
                r3 = i2.default.getFirstMatch(/presto\/(\d+(\.?_?\d+)+)/i, e3);
              return r3 && (t3.version = r3), t3;
            },
          },
          {
            ...
            describe: function (e3) {
              var t3 = { name: s2.ENGINE_MAP.Gecko },
                r3 = i2.default.getFirstMatch(/gecko\/(\d+(\.?_?\d+)+)/i, e3);
              return r3 && (t3.version = r3), t3;
            },
          },
          {
          ...
          },
          {
            ...
            describe: function (e3) {
              var t3 = { name: s2.ENGINE_MAP.WebKit },
                r3 = i2.default.getFirstMatch(/webkit\/(\d+(\.?_?\d+)+)/i, e3);
              return r3 && (t3.version = r3), t3;
            },
          },
        ];
...
var parseBody = async (request2, options = Object.create(null)) => {
  ...
  const headers =
    request2 instanceof HonoRequest ? request2.raw.headers : request2.headers;
...
var Context = class {
  ...
  json = (object, arg, headers) => {
    ...
    return typeof arg === "number"
      ? this.newResponse(body2, arg, headers)
      : this.newResponse(body2, arg);
  };
  ...
  dispatch(request3, executionCtx, env, method) {
    if (method === "HEAD") {
      return (async () =>
        new Response(
          null,
          await this.dispatch(request3, executionCtx, env, "GET"),
        ))();
    }
      ...
      for (let j = 0, len2 = curNodes.length; j < len2; j++) {
        ...
        for (let k = 0, len3 = node3.patterns.length; k < len3; k++) {
          ...
          if (matcher instanceof RegExp && matcher.test(restPathString)) {
            ...
            handlerSets.push(
              ...this.gHSets(child, method, node3.params, params),
            );
            continue;
          }
          if (
...
function addExpectContinueMiddleware(options) {
  return (next) => async (args) => {
    ...
    if (
      HttpRequest.isInstance(request3) &&
      request3.body &&
...
var getChecksumAlgorithmForRequest = (
  input,
  { requestChecksumRequired, requestAlgorithmMember },
  isS3Express,
) => {
  const defaultAlgorithm = isS3Express
...
var Crc32 = (function () {
  ...
  Crc322.prototype.update = function (data) {
    ...
    try {
      for (
        var data_1 = __values(data), data_1_1 = data_1.next();
        !data_1_1.done;
        data_1_1 = data_1.next()
      ) {
        var byte = data_1_1.value;
        this.checksum =
          (this.checksum >>> 8) ^ lookupTable[(this.checksum ^ byte) & 255];
      }
    } catch (e_1_1) {
      e_1 = { error: e_1_1 };
    } finally {
  ...
  Crc32c2.prototype.update = function (data) {
    ...
    try {
      for (
        ...
        var byte = data_1_1.value;
        this.checksum =
          (this.checksum >>> 8) ^ lookupTable2[(this.checksum ^ byte) & 255];
      }
    } catch (e_1_1) {
      e_1 = { error: e_1_1 };
    } finally {
...
var a_lookupTable = [
  ...
  837199303, 582374963, 3504198960, 68661723, 4135334616, 3844915500, 390545967,
  1230274059, 3141532936, 2825850620, 1510247935, 2395924756, 2091215383,
  1878366691, 2644384480, 3553878443, 565732008, 854102364, 3229815391,
  340358836, 3861050807, 4117890627, 119113024, 1493875044, 2875275879,
  3090270611, 1247431312, 2660249211, 1828433272, 2141937292, 2378227087,
  3811616794, 291187481, 34330861, 4032846830, 615137029, 3603020806,
  3314634738, 939183345, 1776939221, 2609017814, 2295496738, 2058945313,
  2926798794, 1545135305, 1330124605, 3173225534, 4084100981, 17165430,
  307568514, 3762199681, 888469610, 3332340585, 3587147933, 665062302,
  2042050490, 2346497209, 2559330125, 1793573966, 3190661285, 1279665062,
...
var flexibleChecksumsMiddleware =
  (config2, middlewareConfig) => (next, context3) => async (args) => {
    ...
    const { input, requestChecksumRequired, requestAlgorithmMember } =
      middlewareConfig;
    ...
    if (checksumAlgorithm) {
      ...
      const checksumAlgorithmFn = selectChecksumAlgorithmFunction(
        checksumAlgorithm,
        config2,
      );
      if (isStreaming(requestBody)) {
        ...
        const rawChecksum = await stringHasher(
          checksumAlgorithmFn,
          requestBody,
        );
        updatedHeaders = {
...
var getChecksumAlgorithmListForResponse = (responseAlgorithms = []) => {
  ...
  for (const algorithm of PRIORITY_ORDER_ALGORITHMS) {
    if (
      !responseAlgorithms.includes(algorithm) ||
      !CLIENT_SUPPORTED_ALGORITHMS.includes(algorithm)
    ) {
      continue;
    }
...
var getChecksum = async (
  body2,
  { streamHasher, checksumAlgorithmFn, base64Encoder },
) => {
  const digest = isStreaming(body2)
    ? streamHasher(checksumAlgorithmFn, body2)
    : stringHasher(checksumAlgorithmFn, body2);
  return base64Encoder(await digest);
};

// node_modules/@aws-sdk/middleware-flexible-checksums/dist-es/validateChecksumFromResponse.js
var validateChecksumFromResponse = async (
  response2,
  { config: config2, responseAlgorithms },
) => {
  ...
  for (const algorithm of checksumAlgorithms) {
    ...
    if (checksumFromResponse) {
      ...
      const checksum3 = await getChecksum(responseBody, {
        streamHasher,
        checksumAlgorithmFn,
        base64Encoder,
      });
      ...
      throw new Error(
        `Checksum mismatch: expected "${checksum3}" but received "${checksumFromResponse}"` +
...
var flexibleChecksumsResponseMiddleware =
  (config2, middlewareConfig) => (next, context3) => async (args) => {
    ...
    const { requestValidationModeMember, responseAlgorithms } =
      middlewareConfig;
    if (
      ...
      const isS3WholeObjectMultipartGetResponseChecksum =
        ...
        getChecksumAlgorithmListForResponse(responseAlgorithms).every(
          (algorithm) => {
            const responseHeader = getChecksumLocationName(algorithm);
...
var getFlexibleChecksumsPlugin = (config2, middlewareConfig) => ({
  applyToStack: (clientStack) => {
    clientStack.add(
      flexibleChecksumsMiddleware(config2, middlewareConfig),
      flexibleChecksumsMiddlewareOptions,
    );
    clientStack.addRelativeTo(
      flexibleChecksumsResponseMiddleware(config2, middlewareConfig),
      flexibleChecksumsResponseMiddlewareOptions,
    );
  },
});
// node_modules/@smithy/util-middleware/dist-es/getSmithyContext.js
var getSmithyContext = (context3) =>
  context3[SMITHY_CONTEXT_KEY] || (context3[SMITHY_CONTEXT_KEY] = {});
...
var hostHeaderMiddleware = (options) => (next) => async (args) => {
  ...
  if (handlerProtocol.indexOf("h2") >= 0 && !request3.headers[":authority"]) {
    ...
    request3.headers[":authority"] =
      request3.hostname + (request3.port ? ":" + request3.port : "");
  } else if (!request3.headers["host"]) {
    let host = request3.hostname;
    if (request3.port != null) host += `:${request3.port}`;
...
var loggerMiddleware = () => (next, context3) => async (args) => {
  try {
    ...
    const inputFilterSensitiveLog =
      overrideInputFilterSensitiveLog ?? context3.inputFilterSensitiveLog;
    const outputFilterSensitiveLog =
      overrideOutputFilterSensitiveLog ?? context3.outputFilterSensitiveLog;
...
var recursionDetectionMiddleware = (options) => (next) => async (args) => {
  ...
  if (
    !HttpRequest.isInstance(request3) ||
    options.runtime !== "node" ||
    request3.headers.hasOwnProperty(TRACE_ID_HEADER_NAME)
  ) {
    return next(args);
  }
...
var constructStack = () => {
  ...
  const stack = {
    ...
    resolve: (handler, context3) => {
      for (const middleware2 of getMiddlewareList()
...
class Client {
  ...
  send(command2, optionsOrCb, cb) {
    ...
    const useHandlerCache =
      options === undefined && this.config.cacheMiddleware === true;
    let handler;
    if (useHandlerCache) {
      if (!this.handlers) {
      ...
      if (handlers.has(command2.constructor)) {
        ...
        handler = command2.resolveMiddleware(
  ...
  return new ReadableStream({
    async pull(controller) {
      ...
      if (done) {
        ...
        controller.enqueue(
          `${(bodyLengthChecker(value) || 0).toString(16)}\r\n${value}\r\n`,
        );
      }
    },
  });
...
var escapeUri = (uri2) =>
  encodeURIComponent(uri2).replace(/[!'()*]/g, hexEncode);
...
class FetchHttpHandler {
  ...
  async handle(request3, { abortSignal } = {}) {
    ...
    const body2 =
      method === "GET" || method === "HEAD" ? undefined : request3.body;
...
var isReadableStream = (stream2) =>
  typeof ReadableStream === "function" &&
  (stream2?.constructor?.name === ReadableStream.name ||
  ...
  return Object.assign(stream2, {
    ...
    transformToWebStream: () => {
      ...
      if (isBlobInstance(stream2)) {
        ...
        throw new Error(
          `Cannot transform payload to web stream, got ${stream2}`,
        );
      }
    },
  });
};
var isBlobInstance = (stream2) =>
  typeof Blob === "function" && stream2 instanceof Blob;
...
class Command {
  ...
  resolveMiddlewareWithContext(
    ...
    return stack.resolve(
      (request3) => requestHandler.handle(request3.request, options || {}),
...
var parseTwoDigitYear = (value) => {
  ...
  const valueInThisCentury =
    ...
    strictParseShort(stripLeadingZeroes(value));
...
var applyInstruction = (target, source, instructions, targetKey) => {
  ...
  if (typeof value === "function") {
    ...
    const defaultFilterPassed =
      filter === undefined && (_value = value()) != null;
    const customFilterPassed =
      (typeof filter === "function" && !!filter(undefined)) ||
  ...
  return (next, context3) => async (args) => {
    ...
    if (HttpRequest.isInstance(request3)) {
      if (!(CONTENT_LENGTH_HEADER in request3.headers)) {
        ...
        if (
          typeof context3?.logger?.warn === "function" &&
          !(context3.logger instanceof NoOpLogger)
        ) {
      ...
      if (response2.headers.expires) {
        ...
        try {
          ...
          context3.logger?.warn(
            `AWS SDK Warning for ${context3.clientName}::${context3.commandName} response parsing (${response2.headers.expires}): ${e}`,
          );
...
var getS3ExpiresMiddlewarePlugin = (clientConfig) => ({
  applyToStack: (clientStack) => {
    clientStack.addRelativeTo(
      s3ExpiresMiddleware(clientConfig),
    ...
    if (entry) {
      return entry.identity.then((identity3) => {
        ...
        const isExpiringSoon =
          (identity3.expiration?.getTime() ?? 0) <
          Date.now() + S3ExpressIdentityProviderImpl.REFRESH_WINDOW_MS;
  ...
  for (const key of Object.keys(query)) {
    ...
    if (typeof value === "string") {
      ...
      serialized[encodedKey] = value
        ...
        .reduce(
          (encoded, value2) =>
            encoded.concat([`${encodedKey}=${escapeUri(value2)}`]),
          [],
        )
        .sort()
        .join("&");
...
class SignatureV4 {
  ...
  async presign(originalRequest, options = {}) {
    ...
    request3.query[CREDENTIAL_QUERY_PARAM] =
    ...
    request3.query[SIGNED_HEADERS_QUERY_PARAM] =
      getCanonicalHeaderList(canonicalHeaders);
    request3.query[SIGNATURE_QUERY_PARAM] = await this.getSignature(
      longDate,
      scope,
  ...
  async signRequest(
    ...
    const signature2 = await this.getSignature(
      longDate,
      scope,
      this.getSigningKey(credentials, region, shortDate, signingService),
      this.createCanonicalRequest(request3, canonicalHeaders, payloadHash),
    );
    request3.headers[AUTH_HEADER] =
...
var setSingleOverride = function (
  privateAccess,
  ...
  return (next, context3) => async (args) => {
    if (context3.endpointV2) {
      ...
      const isS3ExpressAuth =
        endpoint2.properties?.authSchemes?.[0]?.name === S3_EXPRESS_AUTH_SCHEME;
      const isS3ExpressBucket =
        endpoint2.properties?.backend === S3_EXPRESS_BACKEND ||
        endpoint2.properties?.bucketType === S3_EXPRESS_BUCKET_TYPE;
...
var httpAuthSchemeMiddleware =
  (config2, mwOptions) => (next, context3) => async (args) => {
    const options = config2.httpAuthSchemeProvider(
      await mwOptions.httpAuthSchemeParametersProvider(
        config2,
        context3,
        args.input,
      ),
    ...
    for (const option of options) {
      ...
      const { identityProperties = {}, signingProperties = {} } =
        option.propertiesExtractor?.(config2, context3) || {};
...
var createConfigValueProvider = (
  ...
  const configProvider = async () => {
    const configValue =
      config2[configKey] ?? config2[canonicalEndpointParamKey];
  ...
  if (
    ...
    return async () => {
      const credentials =
        typeof config2.credentials === "function"
          ? await config2.credentials()
          : config2.credentials;
      const configValue =
...
var serializerMiddleware =
  (options, serializer) => (next, context3) => async (args) => {
    const endpoint2 =
      context3.endpointV2?.url && options.urlParser
        ? async () => options.urlParser(context3.endpointV2.url)
        : options.endpoint;
    if (!endpoint2) {
      throw new Error("No valid endpoint provider available.");
    }
    const request3 = await serializer(args.input, {
      ...options,
      endpoint: endpoint2,
    });
    return next({
...
function getSerdePlugin(config2, serializer, deserializer) {
  return {
    applyToStack: (commandStack) => {
      commandStack.add(
        deserializerMiddleware(config2, deserializer),
        deserializerMiddlewareOption,
      );
      commandStack.add(
        serializerMiddleware(config2, serializer),
...
var resolveEndpointConfig = (input) => {
  ...
  const customEndpointProvider =
    endpoint2 != null
      ? async () => toEndpointV1(await normalizeProvider(endpoint2)())
      : undefined;
...
var getHttpAuthSchemeEndpointRuleSetPlugin = (
  ...
  applyToStack: (clientStack) => {
    clientStack.addRelativeTo(
      httpAuthSchemeMiddleware(config2, {
...
var httpSigningMiddleware = (config2) => (next, context3) => async (args) => {
  ...
  (signer.successHandler || defaultSuccessHandler)(
    output.response,
    signingProperties,
  );
  return output;
...
var retryMiddleware = (options) => (next, context3) => async (args) => {
  ...
  if (isRetryStrategyV2(retryStrategy)) {
    ...
    while (true) {
      try {
        if (isRequest) {
          request3.headers[REQUEST_HEADER] =
...
var getRetryAfterHint = (response2) => {
  if (!HttpResponse.isInstance(response2)) return;
  const retryAfterHeaderName = Object.keys(response2.headers).find(
...
var createIsIdentityExpiredFunction = (expirationMs) => (identity3) =>
  doesIdentityRequireRefresh(identity3) &&
  identity3.expiration.getTime() - Date.now() < expirationMs;
var EXPIRATION_MS = 300000;
var isIdentityExpired = createIsIdentityExpiredFunction(EXPIRATION_MS);
var doesIdentityRequireRefresh = (identity3) =>
  identity3.expiration !== undefined;
var memoizeIdentityProvider = (provider, isExpired, requiresRefresh) => {
  ...
  const normalizedProvider =
    typeof provider !== "function"
      ? async () => Promise.resolve(provider)
      : provider;
  let resolved;
  let pending;
  let hasResult;
...
var s3ExpressHttpSigningMiddleware =
  (config5) => (next, context3) => async (args) => {
    if (!HttpRequest.isInstance(args.request)) {
      return next(args);
    }
    const smithyContext = getSmithyContext(context3);
    ...
    if (context3.s3ExpressIdentity) {
      request3 = await signS3Express(
        context3.s3ExpressIdentity,
        signingProperties,
        args.request,
        await config5.signer(),
      );
    } else {
    ...
    (signer.successHandler || defaultSuccessHandler2)(
      output.response,
      signingProperties,
    );
    return output;
...
var getS3ExpressHttpSigningPlugin = (config5) => ({
  applyToStack: (clientStack) => {
    clientStack.addRelativeTo(
      s3ExpressHttpSigningMiddleware(config5),
      httpSigningMiddlewareOptions,
    );
  },
});
...
var throw200ExceptionsMiddleware =
  (config5) => (next, context3) => async (args) => {
    ...
    if (
      ...
      !(sourceBody instanceof Uint8Array)
    ) {
    ...
    const bodyStringTail = config5.utf8Encoder(
      bodyBytes.subarray(bodyBytes.length - 16),
    );
...
var collectBody2 = (streamBody = new Uint8Array(), context3) => {
  ...
  return (
    context3.streamCollector(streamBody) || Promise.resolve(new Uint8Array())
  );
};
...
var getThrow200ExceptionsPlugin = (config5) => ({
  applyToStack: (clientStack) => {
    clientStack.addRelativeTo(
      throw200ExceptionsMiddleware(config5),
...
function resolveUserAgentConfig(input) {
  const normalizedAppIdProvider = normalizeProvider3(
  ...
  const whatwgURL = (() => {
    try {
      ...
      if (typeof value === "object" && "hostname" in value) {
        ...
        url6.search = Object.entries(query)
          .map(([k, v]) => `${k}=${v}`)
          .join("&");
        return url6;
      }
...
var getEndpointProperties2 = (properties, options) =>
...
var evaluateEndpointRule = (endpointRule, options) => {
  ...
  options.logger?.debug?.(
    `${debugId} Resolving endpoint from template: ${toDebugString(endpoint2)}`,
  );
  return {
    ...(headers != null && {
...
var resolveEndpoint = (ruleSetObject, options) => {
  ...
  const endpoint2 = evaluateRules2(rules, {
    endpointParams,
    logger: logger3,
    referenceRecord: {},
  });
  options.logger?.debug?.(
    `${debugId} Resolved endpoint: ${toDebugString(endpoint2)}`,
  );
  return endpoint2;
};
...
var partition = (value) => {
  ...
  const DEFAULT_PARTITION = partitions2.find(
...
var userAgentMiddleware = (options) => (next, context3) => async (args) => {
  ...
  defaultUserAgent.push(
    `m/${encodeFeatures(Object.assign({}, context3.__smithy_context?.features, awsContext.__aws_sdk_context?.features))}`,
  );
...
var getDateHeader = (response2) =>
  HttpResponse.isInstance(response2)
    ? (response2.headers?.date ?? response2.headers?.Date)
    : undefined;
...
var validateSigningProperties = async (signingProperties) => {
  const context3 = throwSigningPropertyError(
    "context",
...
class AwsSdkSigV4Signer {
  ...
  errorHandler(signingProperties) {
    return (error) => {
      ...
      if (serverTime) {
        const config6 = throwSigningPropertyError(
          "config",
          signingProperties.config,
        );
        const initialSystemClockOffset = config6.systemClockOffset;
        config6.systemClockOffset = getUpdatedSystemClockOffset(
          serverTime,
          config6.systemClockOffset,
        );
        const clockSkewCorrected =
          config6.systemClockOffset !== initialSystemClockOffset;
...
class AwsSdkSigV4ASigner extends AwsSdkSigV4Signer {
  async sign(httpRequest2, identity3, signingProperties) {
    ...
    const configResolvedSigningRegionSet =
      await config6.sigv4aSigningRegionSet?.();
...
var resolveAwsSdkSigV4AConfig = (config6) => {
  config6.sigv4aSigningRegionSet = normalizeProvider3(
    config6.sigv4aSigningRegionSet,
  );
  return config6;
};
...
var resolveAwsSdkSigV4Config = (config6) => {
  ...
  if (config6.credentials) {
    normalizedCreds = memoizeIdentityProvider(
      config6.credentials,
      isIdentityExpired,
  ...
  if (!normalizedCreds) {
    if (config6.credentialDefaultProvider) {
      normalizedCreds = normalizeProvider3(
        config6.credentialDefaultProvider(
          Object.assign({}, config6, {
  ...
  const {
    ...
    systemClockOffset = config6.systemClockOffset || 0,
    sha256,
  } = config6;
  let signer;
  if (config6.signer) {
    ...
    signer = () =>
      normalizeProvider3(config6.region)()
        .then(async (region) => [
        ...
        .then(([regionInfo2, region]) => {
          ...
          config6.signingRegion =
            config6.signingRegion || signingRegion || region;
          config6.signingName =
            config6.signingName || signingService || config6.serviceId;
          const params = {
            ...config6,
...
var collectBodyString = (streamBody, context3) =>
  collectBody(streamBody, context3).then((body2) =>
    context3.utf8Encoder(body2),
  );

// node_modules/@aws-sdk/core/dist-es/submodules/protocols/xml/parseXmlBody.js
var import_fast_xml_parser = __toESM(require_fxp(), 1);
var parseXmlBody = (streamBody, context3) =>
  collectBodyString(streamBody, context3).then((encoded) => {
    if (encoded.length) {
...
var al = {
  [cn]: "S3Express",
  [co]: [
    { [cp]: true, [i]: "sigv4-s3express", [cq]: "s3express", [cr]: "{Region}" },
  ],
};
...
var bZ = [
  { [ch]: g, [ci]: [aY, { [ch]: h, [ci]: [{ [cj]: "partitionResult" }, i] }] },
];
              ...
              rules: [
                {
                  ...
                  rules: [
                    ...
                    },
                    {
                      [cg]: bF,
                      rules: [
                        { endpoint: { [cl]: q, [cm]: ah, [cs]: ai }, [cf]: n },
                      ],
                      [cf]: o,
                    },
                    ak,
                  ...
                  rules: [
                    {
                      [cg]: bE,
                      rules: [
                        { endpoint: { [cl]: m, [cm]: al, [cs]: ai }, [cf]: n },
                      ],
                      [cf]: o,
                    },
                  ],
...
var createEndpointRuleSetHttpAuthSchemeParametersProvider =
  (defaultHttpAuthSchemeParametersProvider) =>
  async (config6, context3, input) => {
    if (!input) {
      throw new Error(
        `Could not find \`input\` for \`defaultEndpointRuleSetHttpAuthSchemeParametersProvider\``,
      );
    }
    const defaultParameters = await defaultHttpAuthSchemeParametersProvider(
      config6,
      context3,
      input,
    );
    const instructionsFn =
      getSmithyContext(context3)?.commandInstance?.constructor
        ?.getEndpointParameterInstructions;
    if (!instructionsFn) {
      throw new Error(
        `getEndpointParameterInstructions() is not defined on \`${context3.commandName}\``,
      );
    }
...
var _defaultS3HttpAuthSchemeParametersProvider = async (
  config6,
  context3,
  input,
) => {
  return {
    ...
    region:
      (await normalizeProvider(config6.region)()) ||
      (() => {
        throw new Error(
  ...
  const endpointRuleSetHttpAuthSchemeProvider = (authParameters) => {
    ...
    for (const scheme of authSchemes) {
      ...
      if (resolvedName !== name) {
        console.warn(
          `HttpAuthScheme has been normalized with lowercasing: \`${resolvedName}\` to \`${name}\``,
        );
      }
      let schemeId;
      if (name === "sigv4a") {
        ...
        throw new Error(
          `Unknown HttpAuthScheme found in \`@smithy.rules#endpointRuleSet\`: \`${name}\``,
        );
      }
      const createOption = createHttpAuthOptionFunctions[schemeId];
      if (!createOption) {
        throw new Error(
          `Could not find HttpAuthOption create function for \`${schemeId}\``,
        );
      }
...
var se_GetObjectCommand = async (input, context3) => {
  ...
  const headers = map({}, isSerializableHeaderValue, {
    ...
    [_ims]: [
      ...
      () => dateToUtcString(input[_IMS]).toString(),
    ],
    [_inm]: input[_INM],
    [_ius]: [
      () => isSerializableHeaderValue(input[_IUS]),
      () => dateToUtcString(input[_IUS]).toString(),
    ],
    [_ra]: input[_R],
  ...
  const query = map({
    ...
    [_re]: [
      ...
      () => dateToUtcString(input[_RE]).toString(),
    ],
    [_vI]: [, input[_VI]],
...
var se_PutObjectCommand = async (input, context3) => {
  ...
  const headers = map({}, isSerializableHeaderValue, {
    ...
    [_e]: [
      ...
      () => dateToUtcString(input[_E]).toString(),
    ],
    [_inm]: input[_INM],
    [_xagfc]: input[_GFC],
    [_xagr]: input[_GR],
...
var de_CreateSessionCommand = async (output, context3) => {
  ...
  const contents = map({
    ...
    [_BKE]: [
      () => output.headers[_xassebke] !== undefined,
      () => parseBoolean(output.headers[_xassebke]),
    ],
  });
  const data = expectNonNull(
    expectObject(await parseXmlBody(output.body, context3)),
    "body",
  );
  if (data[_C] != null) {
...
var de_GetObjectCommand = async (output, context3) => {
  ...
  const contents = map({
    $metadata: deserializeMetadata2(output),
    [_DM]: [
      () => output.headers[_xadm] !== undefined,
      () => parseBoolean(output.headers[_xadm]),
    ],
    [_AR]: [, output.headers[_ar]],
    [_Exp]: [, output.headers[_xae]],
    [_Re]: [, output.headers[_xar]],
    [_LM]: [
      () => output.headers[_lm] !== undefined,
      () => expectNonNull(parseRfc7231DateTime(output.headers[_lm])),
    ],
    [_CLo]: [
      () => output.headers[_cl_] !== undefined,
      () => strictParseLong(output.headers[_cl_]),
    ],
    ...
    [_MM]: [
      () => output.headers[_xamm] !== undefined,
      () => strictParseInt32(output.headers[_xamm]),
    ],
    ...
    [_E]: [
      () => output.headers[_e] !== undefined,
      () => expectNonNull(parseRfc7231DateTime(output.headers[_e])),
    ],
    ...
    [_PC]: [
      () => output.headers[_xampc] !== undefined,
      () => strictParseInt32(output.headers[_xampc]),
    ],
    [_TC]: [
      () => output.headers[_xatc] !== undefined,
      () => strictParseInt32(output.headers[_xatc]),
    ],
...
class CreateSessionCommand extends Command.classBuilder()
  .ep({
    ...commonParams,
  ...
  RawSha2562.prototype.hashBuffer = function () {
    ...
    for (var i2 = 0; i2 < BLOCK_SIZE; i2++) {
      if (i2 < 16) {
        ...
        var t1_1 =
          ((u2 >>> 17) | (u2 << 15)) ^ ((u2 >>> 19) | (u2 << 13)) ^ (u2 >>> 10);
        u2 = this.temp[i2 - 15];
        var t2_1 =
          ((u2 >>> 7) | (u2 << 25)) ^ ((u2 >>> 18) | (u2 << 14)) ^ (u2 >>> 3);
        this.temp[i2] =
          ((t1_1 + this.temp[i2 - 7]) | 0) + ((t2_1 + this.temp[i2 - 16]) | 0);
      }
      var t1 =
        ((((((state4 >>> 6) | (state4 << 26)) ^
          ((state4 >>> 11) | (state4 << 21)) ^
          ...
          0) +
          ((state7 + ((KEY[i2] + this.temp[i2]) | 0)) | 0)) |
        0;
      var t2 =
        ((((state0 >>> 2) | (state0 << 30)) ^
          ((state0 >>> 13) | (state0 << 19)) ^
...
class EventStreamCodec {
  ...
  encode({ headers: rawHeaders, body: body2 }) {
    ...
    view.setUint32(
      length - 4,
      checksum4.update(out.subarray(8, length - 4)).digest(),
      false,
    );
    return out;
  }
...
class EventStreamMarshaller4 {
  ...
  deserialize(body2, deserializer) {
    const bodyIterable = isReadableStream2(body2)
      ? readableStreamtoIterable(body2)
      : body2;
...
var isReadableStream2 = (body2) =>
  typeof ReadableStream === "function" && body2 instanceof ReadableStream;
...
var getRuntimeConfig = (config6) => {
  return {
    ...
    getAwsChunkedEncodingStream:
      config6?.getAwsChunkedEncodingStream ?? getAwsChunkedEncodingStream,
    httpAuthSchemeProvider:
      config6?.httpAuthSchemeProvider ?? defaultS3HttpAuthSchemeProvider,
...
var resolveDefaultsModeConfig = ({ defaultsMode } = {}) =>
  memoize(async () => {
    const mode =
      typeof defaultsMode === "function" ? await defaultsMode() : defaultsMode;
...
var getRuntimeConfig2 = (config6) => {
  ...
  return {
    ...
    defaultUserAgentProvider:
      config6?.defaultUserAgentProvider ??
      defaultUserAgent({
        serviceId: clientSharedValues.serviceId,
        clientVersion: package_default.version,
      }),
    eventStreamSerdeProvider:
      config6?.eventStreamSerdeProvider ?? eventStreamSerdeProvider,
    ...
    requestHandler: FetchHttpHandler.create(
      config6?.requestHandler ?? defaultConfigProvider,
    ),
    retryMode:
      config6?.retryMode ??
      (async () =>
    ...
    useDualstackEndpoint:
      config6?.useDualstackEndpoint ??
      (() => Promise.resolve(DEFAULT_USE_DUALSTACK_ENDPOINT)),
    useFipsEndpoint:
      config6?.useFipsEndpoint ??
...
class GetObjectCommand extends Command.classBuilder()
  .ep({
    ...commonParams,
    Bucket: { type: "contextParams", name: "Bucket" },
...
class HeadObjectCommand extends Command.classBuilder()
  .ep({
    ...commonParams,
    Bucket: { type: "contextParams", name: "Bucket" },
    Key: { type: "contextParams", name: "Key" },
...
class PutObjectCommand extends Command.classBuilder()
  .ep({
    ...commonParams,
    Bucket: { type: "contextParams", name: "Bucket" },
    Key: { type: "contextParams", name: "Key" },
...
var getSignedUrl = async (client3, command3, options = {}) => {
  ...
  if (typeof client3.config.endpointProvider === "function") {
    const endpointV2 = await getEndpointFromInstructions(
      command3.input,
      command3.constructor,
      client3.config,
    );
  ...
  const presignInterceptMiddleware = (next, context3) => async (args) => {
    ...
    const presignerOptions = {
      ...options,
      signingRegion:
        options.signingRegion ?? context3["signing_region"] ?? region,
